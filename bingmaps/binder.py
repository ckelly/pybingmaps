        ...
        def build_parameters(self, args, kargs):
            ...
            for idx, arg in enumerate(args):
                ...
                try:
                    ...
                    raise BingMapsError('Too many parameters supplied!')

            for k, arg in kargs.items():
                if arg is None:
                    continue
                if k in self.parameters:
                    raise BingMapsError('Multiple values for parameter %s supplied!' % k)
        ...
        def build_path(self):
            for variable in re_path_template.findall(self.path):
                ...
                try:
                    ...
                    raise BingMapsError('No parameter value found for path variable: %s' % name)
        ...
        def execute(self):
            ...
            while retries_performed < self.retry_count + 1:
                ...
                try:
                    ...
                    raise BingMapsError('Failed to send request: %s' % e)
            ...
            if resp.status != 200:
                try:
                    ...
                    error_msg = "Bing Maps error response: status code = %s" % resp.status
                raise BingMapsError(error_msg, resp)
